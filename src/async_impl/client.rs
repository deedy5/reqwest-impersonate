...
use crate::imp::{configure_impersonate, Impersonate, ImpersonateOS};
...
impl ClientBuilder {
    ...
    pub fn impersonate_random(self) -> ClientBuilder {
        use crate::imp::{
            get_random_impersonate_config, random_impersonate, random_impersonate_os,
        };

        let chrome_version = random_impersonate();
        let os_type = random_impersonate_os();

        let (final_chrome, final_os) =
            get_random_impersonate_config(Some(chrome_version), Some(os_type));
